...
sudo pacman -S openbox tint2 rofi tilix openssh lxappearance-obconf vim zsh lolcat xclip nodejs python jq wget pulseaudio pavucontrol compton nitrogen keepass firefox mps-youtube youtube-dl git curl wmctrl xorg-xinit xorg-server xorg-xprop networkmanager bc dina-font otf-font-awesome
